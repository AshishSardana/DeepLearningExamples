...
docker run --runtime=nvidia --rm $DETACHED \
   ...
   gitlab-master.nvidia.com:5005/dl/dgx/tritonserver/tritonserver-21.02-modified:cublas_11.2_cudnn_8.0.4_tf_2.3.0-devel tritonserver --model-store=/models --backend-config=tensorflow,version=2 --model-control-mode=explicit
